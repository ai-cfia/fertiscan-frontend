    ...
    return (
        <div className="side-menu" ref={SideMenuRef}>
            <div className="side-menu_content">
                <ul>
                    <li> <a  className="side-menu_item" onClick={goToHome}>
                        <img className="menu-icon" src={home}></img> <span>{t("Home")}</span>
                    </a> </li>
                    <li> <a className="side-menu_item" onClick={goToSettings}>
                        <img className="menu-icon" src={settings}></img> <span>{t("Settings")}</span>
                    </a> </li>
                </ul>
            </div>
        </div>
