...
test('should analyze and classify code sections correctly in file: ExportedDontMatchMain', () => {
    const filePath = 'src/testfiles/ExportedDontMatchMain.tsx';
    const content = readFileContent(filePath);
    ...
    expect(sections).toHaveProperty('components');
    expect(sections.components.length).toBe(2);
    ...
    expect(sections).toHaveProperty('functionalComponent');
    expect(sections.functionalComponent.length).toBe(2);
